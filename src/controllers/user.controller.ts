...
import genertedRefreshToken from "../utils/generatedRefreshToken";
...
//logout controller
export async function logoutController(request:Request, response:any) {
  try {
...
export async function uploadAvatar(request:any, response:any) {
  try {
    ...
    const upload:any = await uploadImageClodinary(image);
...
//update user details
export async function updateUserDetails(request:Request, response:any) {
  try {
...
export async function forgotPasswordController(request:Request, response:any) {
  try {
...
export async function verifyForgotPasswordOtp(request:Request, response:any) {
  try {
...
//reset the password
export async function resetpassword(request:Request, response:any) {
  try {
...
export async function refreshToken(request:Request, response:any) {
  try {
    const refreshToken =
...
export async function userDetails(request:Request, response:any) {
  try {
